...
const submit = () => {
  let data = {
   ...
   if (!data.Patient_Name || !data.Personal_ID || !data.Hospital_Number ){
    ...
    setErrorMessage("กรอกข้อมูลไม่ครบ")
    setError(true)
    return
  }
      ...
      .then((res) => {
        if (res.data) {
          ...
          if (res.error == "UNIQUE constraint failed: medical_records.hospital_number") {
            setErrorMessage("รหัสผู้ป่วยซ้ำ")
        } else if (res.error == "UNIQUE constraint failed: medical_records.personal_id") {
            setErrorMessage("เลขประจำตัวประชาชนผู้ป่วยซ้ำ")
        } else {
                ...
                <Grid container spacing={5}>
                    ...
                    <Grid item xs={6}>
                        ...
                        <Select variant="outlined"                         
                            ...
                            fullWidth
                        >
                            <MenuItem value={0} key={0} disabled >กรุณาเลือกคำนำหน้า</MenuItem>
                    ...
                    <Grid item xs={6}>
                        ...
                        <Select variant="outlined"                         
                            ...
                            fullWidth
                        >
                            <MenuItem value={0} key={0} disabled >กรุณาเลือกสิทธิการรักษา</MenuItem>
